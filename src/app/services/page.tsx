      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div 
                className="w-24 h-24 mx-auto mb-6 rounded-lg shadow-md flex items-center justify-center"
                style={{
                  backgroundImage: "url('/lithium-bg.jpg')",
            ...
            >
              <div 
                className="w-24 h-24 mx-auto mb-6 rounded-lg shadow-md flex items-center justify-center"
                style={{
                  backgroundImage: "url('/beryllium.jpg')",
                  backgroundSize: "cover",
                  backgroundPosition: "center"
                }}
              >
            ...
            >
              <div 
                className="w-24 h-24 mx-auto mb-6 rounded-lg shadow-md flex items-center justify-center"
                style={{
                  backgroundImage: "url('/gold-bg.jpg')",
                  backgroundSize: "cover",
                  backgroundPosition: "center"
                }}
              >
